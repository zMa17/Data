...
with open("EN_Coral_translated.csv", "r", encoding="utf-8") as f:
...
# Simpan hasil
with open("EN_Coral_translated.xml", "w", encoding="utf-8") as f:
    f.write(new_xml)

print("✅ Merge selesai! Cek file EN_Coral_translated.xml")
